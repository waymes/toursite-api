const firstBlockItems = [
  ...
  },
  {
    ...
    details: 'проедем, пролетим и проплывём по Ирану с Севера на Персидский залив и обратно',
  },
  {
    title: '45 объектов',
...
const secondBlockItems = [
  ...
  },
  {
    ...
    text: 'Будем кувыркаться с высоких дюн в пустыне и гонять по ним на джипе',
  },
  {
    image: '/static/tour/tour_picture_4.jpg',
    text: 'Купаться в Персидском заливе на вулканическом острове!',
  },
  {
    image: '/static/tour/tour_picture_5.jpg',
    text: 'Побываем в огромном настоящем сейфе - сокровищнице Персии!',
  },
  {
    image: '/static/tour/tour_picture_5.jpg',
    text: 'Жить в средневековом каравансарае для путников Шелкового Пути',
  },
  {
    image: '/static/tour/tour_picture_5.jpg',
    text: 'Гулять по крышам древних городов!',
  },
  {
    image: '/static/tour/tour_picture_5.jpg',
    text: 'Познакомимся с исламской культурой и невероятно открытыми людьми',
  },
];
...
const bulkData = [
  {
    ...
    records: [
      ...
      },
      {
        ...
        image: '/static/tour/tour_picture_3.jpg',
        title: 'Открой для себя магию Европы!',
      ...
      },
      {
        ...
        image: '/static/tour/tour_picture_4.jpg',
        title: 'Открой для себя магию Карпат!',
        destination: 'Карпаты',
        name: 'Поход в Карпаты',
        firstBlockTitle: 'Готовьтесь к самому потрясающему приключению:',
        firstBlockItems: JSON.stringify(firstBlockItems),
        secondBlockTitle: 'Что нас ждёт в поездке?',
        secondBlockItems: JSON.stringify(secondBlockItems),
